# parmem17_16 out-of-context timing constraints for fmax analysis.
#
# Side A (16-lane strided load/store group) and side B (NI) are independent
...
# lane EA adders + CRT decode + bank steering + BRAM access consumes, as
...
set_false_path -hold -from [remove_from_collection [all_inputs] [get_ports {clka clkb}]]
