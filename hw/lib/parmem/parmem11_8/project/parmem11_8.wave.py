# -*- python -*-
"""Wavedisp file for module parmem11_8."""
...
def generator(nb_banks=11, internals=False, banks=False):
    """Generator for module parmem11_8.

    Ports only by default -- with 11 banks the sub-hierarchies alone are
    132 traces, which makes GTKWave crawl.
