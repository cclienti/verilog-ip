# axi_stream_downsizer out-of-context timing constraints for fmax analysis.
...
set_input_delay  -clock clock 0.000 [get_ports {sreset s_axi_tvalid s_axi_tlast m_axi_tready}]
set_input_delay  -clock clock 0.000 [get_ports {s_axi_tdata[*] s_axi_tuser[*] s_axi_tkeep[*]}]
set_output_delay -clock clock 0.000 [get_ports {s_axi_tready m_axi_tvalid m_axi_tlast}]
set_output_delay -clock clock 0.000 [get_ports {m_axi_tdata[*] m_axi_tuser[*]}]
