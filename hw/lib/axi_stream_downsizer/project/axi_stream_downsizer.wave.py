# -*- python -*-
# To include in axi_stream_downsizer_tb.wave.py:
"""Wavedisp file for module axi_stream_downsizer."""
...
def generator():
    """Generator for module axi_stream_downsizer."""
    blk = Block()
    blk.add(Disp("clock"))
    blk.add(Disp("sreset"))
