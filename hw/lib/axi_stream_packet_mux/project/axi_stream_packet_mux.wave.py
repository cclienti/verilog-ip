# -*- python -*-
"""Wavedisp file for module axi_stream_packet_mux."""
...
def generator(internals=False):
    """Generator for module axi_stream_packet_mux."""
    blk = Block()
    blk.add(Disp("clock"))
    blk.add(Disp("sreset"))
    ...
    if internals:
        ...
        internal.add(Disp("busy"))
        internal.add(Disp("sel"))
        internal.add(Disp("ptr"))
