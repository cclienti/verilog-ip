# axi_stream_upsizer out-of-context timing constraints for fmax analysis.
...
set_input_delay  -clock clock 0.000 [get_ports {s_axi_tdata[*] s_axi_tuser[*]}]
set_output_delay -clock clock 0.000 [get_ports {s_axi_tready m_axi_tvalid m_axi_tlast}]
set_output_delay -clock clock 0.000 [get_ports {m_axi_tdata[*] m_axi_tuser[*] m_axi_tkeep[*]}]
