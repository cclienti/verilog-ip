# axi_stream_packet_demux out-of-context timing constraints for fmax analysis.
...
set_input_delay  -clock clock 0.000 [get_ports {s_axi_tdata[*] s_sel[*] s_info[*]}]
...
set_output_delay -clock clock 0.000 [get_ports {m_axi_tdata[*] m_info[*]}]
