...
\begin{itemize}
  ...
  \item An open-source RTL implementation targeting both simulation and FPGA
        ...
        simulation;
  \item Verilator co-simulation results validating the analytical latency model
        and benchmarking a LLaMA~3~8B-scale distributed GeMV, demonstrating a
        $5\times$ throughput gain from a four-master quadrant configuration.
\end{itemize}
