...
For DMA-driven transfers, the \texttt{hynoc\_stream\_writer} and
\texttt{hynoc\_stream\_reader} modules provide continuous packet injection and
reception, maximizing channel utilization for bulk data movement.
