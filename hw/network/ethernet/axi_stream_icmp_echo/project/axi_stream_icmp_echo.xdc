# axi_stream_icmp_echo out-of-context timing constraints for fmax analysis.
...
set_input_delay  -clock clock 0.000 [get_ports {s_src_ip[*] s_dst_ip[*] s_length[*] s_src_mac[*]}]
