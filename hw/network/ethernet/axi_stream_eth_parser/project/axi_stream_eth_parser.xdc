# axi_stream_eth_parser out-of-context timing constraints for fmax analysis.
...
set_input_delay  -clock clock 0.000 [get_ports {sreset promiscuous s_axi_tvalid* s_axi_tlast* s_axi_tuser*}]
set_input_delay  -clock clock 0.000 [get_ports {local_mac[*] s_axi_tdata[*] s_length[*]}]
...
set_output_delay -clock clock 0.000 [get_ports {m_axi_tdata[*] m_sel[*] m_dst_mac[*] m_src_mac[*] m_ethertype[*] m_length[*]}]
