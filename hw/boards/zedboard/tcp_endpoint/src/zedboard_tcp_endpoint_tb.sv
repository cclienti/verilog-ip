...
//-----------------------------------------------------------------------------
// Title         : Zedboard TCP Endpoint Demonstrator Testbench
//-----------------------------------------------------------------------------
// File          : zedboard_tcp_endpoint_tb.sv
...
module zedboard_tcp_endpoint_tb;
    ...
    zedboard_tcp_endpoint zedboard_eth_endpoint_inst
    (
        .clk100     (clk100),
        .btn_reset  (btn),
        .phy_clkin  (clkin),
    ...
    initial begin
        ...
        if (errors == 0)
          $display("zedboard_tcp_endpoint_tb: ALL TESTS PASSED");
        else
          $display("zedboard_tcp_endpoint_tb: %0d ERROR(S)", errors);
        $finish;
    end
